-- 1. CREATE TABLES (RAW DATA STRUCTURE)
--wearable_vitals
...
-- 2. DATA VALIDATION (ROW COUNT CHECK)
...
-- 4. PERFORMANCE OPTIMIZATION (INDEX CREATION)
-- Improve query performance for time-series analysis
...
-- 5. BUILD PATIENT SENSOR STREAM
-- Combine wearable vitals with activity context
...
-- 6. DATA CLEANING
-- Filter invalid physiological values
...
-- ROLLING HRV BASELINE CALCULATION
-- Compute 7-day dynamic baseline using window functions
...
-- Identify abnormal HRV drops during sleep
...
-- 9. PERSISTENT SIGNAL DETECTION
-- Identify repeated signals within a 6-hour window
...
-- 10. RECENT ALERT MONITORING
-- Identify patients with alerts in last 24 hours
SELECT
  patient_id,
...
-- Calculate first detected signal before adverse event
...
-- 12. LEAD TIME SCORING
-- Calculate hours and days between signal and event
...
-- 15. FINAL DATASETS FOR DASHBOARD
SELECT
  patient_id, ts,
